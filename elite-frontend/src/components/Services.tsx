    ...
    <div className="w-full py-16 bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-5">
        <div className="absolute top-10 left-10">
          <FontAwesomeIcon icon={faPaw} style={{ height: '5em', width: '5em' }} className="text-purple-600" />
        </div>
        <div className="absolute bottom-10 right-10">
          <FontAwesomeIcon icon={faPaw} style={{ height: '6em', width: '6em' }} className="text-purple-600" />
        </div>
      </div>
