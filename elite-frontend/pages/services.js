                ...
                >
                  <div className={styles.iconBoxWrapper}>
                    ...
                    <div className={styles.iconBxFooter}>
                      <Link href={`/service-detail/${service.documentId || service.id}`} className={styles.readMoreBtn}>
                        {isRTL ? 'اقرأ المزيد' : 'Read More'}
                      </Link>
                      <Link href={`/service-detail/${service.documentId || service.id}`} className={styles.btnPrimary}>
